...
for n in range(N):
    ...
    if n % 100 == 0:
        model.models[0].save_weights("weights0"+str(n)+".h5")
        model.models[1].save_weights("weights1" + str(n) + ".h5")
        model.models[2].save_weights("weights2" + str(n) + ".h5")
        model.models[3].save_weights("weights3" + str(n) + ".h5")
